...
\cventry{September 2014 -- now}{Spotlime}{Mobile software engineer}{Milan, Italy}{}{
   ...
   Experience in: client-server synchronization, sqlite, background services
   and activity-service communication, credit card payment, integration
   with social channels,
   analytics, maps and geolocation. 
   Knowdledge of SDKs: Facebook, Google Play Services, AppsFlyer, android
   ORMLite, GSon, EventBus.
   ...
   Working alongside server-side and iOS developers to coordinate the upcoming
   releases.
   Spotlime website:
...
\cvitem{Programming Languages}{C++,  Android, Python, C,  FORTRAN~90.
