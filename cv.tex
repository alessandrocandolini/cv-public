...
\cventry{September 2014 -- now}{Spotlime}{Mobile software engineer}{Milan, Italy}{}{
   I am the only person involved in the implementation design, development, QA and
   release of 
   native Android applications for Spotlime, a startup that
   provides apps to discover the best events in Milan. 
   ...
   %Functionality includes: database synchonization with backend, credit card payment, integration
   %with social channels, 
   %analytics, google maps and geolocation. 
   Working alongside marketing team to deliver a product closer
   to real user
   needs, promoting solutions that helps improving user experience in response to end user feedback.
   Working alongside serverside dev to coordinate upcoming work.
   Spotlime website:
\url{http://www.spotli.me/en}}
...
\cventry{October 2012 -- August 2014}{Usablenet - leading global mobile and
   ...
   \begin{itemize}
      %\item 
%maintaining close communication with developer team, project manager and client throughout the 
%life-cycle to ensure expectations were achieved successfully and deadlines were met.
\item 
...
\cventry{September~2011 -- August~2012}{R.U.E. Riserse Umane Europa (no-profit
...
\cventry{2000-2007}{A.F.A.M. (Associazione Friulana di Astronomia e
   ...
   I collaborate in data reduction of VHF radio forward scatter meteor
   observations and detection of Jupiter decametric radio emissions.
   ...
   \newline{}
   Several small projects of statistical data analysis in C and C++.
}
...
\cvitem{Programming Languages}{C++, C, Python, FORTRAN~90.
   Experiences with D, Java, Android, Shell BASH,
   HTML}
\cvitem{Protocols}{XML, JSON}
\cvitem{Database}{SQL, JQL}
\cvitem{IDE and editors}{VI, Sublime Text Editor, Eclipse}
\cvitem{Typesetting}{\LaTeXe} 
\cvitem{Tools for software development and testing}{Atlassian Inc. JIRA, Confluence, TestLodge, CVS, GitHub, BitBucket,
   SourceTree, Asana}
...
\cvlistitem{Topological Quantum Computing and Anyons}
...
\cvlistitem{Listening to blues and progressive rock (expecially Eric
   Clapton, Joe Bonamassa, Mark Knopfler, Eric Johnson)}
\cvlistitem{Reading books (I love Dostoevskij)}
