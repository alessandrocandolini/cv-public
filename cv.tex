...
\cventry{September 2014 -- now}{Spotlime}{Mobile software engineer}{Milan, Italy}{}{
   ...
   Experience in: client-server synchronization, sqlite, 
   activity-service communication, credit card payment, integration
   ...
   The app is freely downloadable from Google play store: 
