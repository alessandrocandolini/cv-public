...
\cventry{September 2014 -- now}{Spotlime}{Mobile software engineer}{Milan, Italy}{}{
   Responsible of the implementation design, development, debug and
   release of 
   native Android and native iOS applications for Spotlime, a startup that
...
\section{Hobbies}
\cvlistitem{Listening to electric guitar (expecially Mark Knopfler, Eric
   Clapton, Eric Johnson)}
