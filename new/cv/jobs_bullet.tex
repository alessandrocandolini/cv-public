...
\item \textbf{Preferred technologies}: 
   ...
   Fresco, firebase, appsflyer. Tests: junit4, mockito, espresso, appium, wiremock.
	\item  CI/CD: I setup the delivery pipeline 
	with unit and espresso tests on aws farm, jacoco, lint
...
\item Key functionalities: 
	client-server data synchronization, offline, 
   advanced geolocation, Facebook SDK, push notifications
