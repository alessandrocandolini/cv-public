...
\item 
	...
	\item Refactor original codebase to increase modularity and testability, promoting adoption of clean architecture, MVP, Rx, Dagger, retrofit and functional programming patterns
...
\item \textbf{Technologies}: 
   ...
   Fresco, firebase, appsflyer. Tests: junit4, mockito, espresso, appium, wiremock.
	\item  CI/CD: I setup the delivery pipeline running
		unit tests, espresso tests on aws farm, jacoco, lint.
